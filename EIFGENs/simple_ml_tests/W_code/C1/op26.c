...
extern EIF_TYPED_VALUE F26_407(EIF_REFERENCE);
extern EIF_TYPED_VALUE F26_408(EIF_REFERENCE);
extern EIF_TYPED_VALUE F26_409(EIF_REFERENCE);
extern EIF_TYPED_VALUE F26_410(EIF_REFERENCE);
extern EIF_TYPED_VALUE F26_411(EIF_REFERENCE);
extern EIF_TYPED_VALUE F26_412(EIF_REFERENCE);
extern EIF_TYPED_VALUE F26_413(EIF_REFERENCE);
...
RTOID (F26_407)
EIF_TYPED_VALUE F26_407 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F26_407);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 25, Current, 0, 0, 426);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(25, Current, 426);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0x08000000, 1,0); /* Result */
	tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(412, dtype))(Current)).it_c1);
...
RTOID (F26_408)
EIF_TYPED_VALUE F26_408 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 25, Current, 0, 0, 427);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(25, Current, 427);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
EIF_TYPED_VALUE F26_409 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 25, Current, 0, 0, 428);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(25, Current, 428);
...
EIF_TYPED_VALUE F26_410 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 25, Current, 0, 0, 429);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(25, Current, 429);
...
EIF_TYPED_VALUE F26_411 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 25, Current, 0, 0, 430);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(25, Current, 430);
...
EIF_TYPED_VALUE F26_412 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 25, Current, 0, 0, 431);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(25, Current, 431);
...
EIF_TYPED_VALUE F26_413 (EIF_REFERENCE Current)
{
	GTCX
