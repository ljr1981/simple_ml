...
static const EIF_TYPE_INDEX egt_0_16 [] = {0xFF01,267,0xFFFF};
...
static const EIF_TYPE_INDEX egt_8_16 [] = {0xFF01,26,0xFFFF};
static const EIF_TYPE_INDEX egt_9_16 [] = {0xFF01,267,0xFFFF};
static const EIF_TYPE_INDEX egt_10_16 [] = {0xFF01,267,0xFFFF};
...
static const struct desc_info desc_16[] = {
	...
	{EIF_NON_GENERIC(0x023F /*287*/), 313, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x023F /*287*/), 314, 0},
	{EIF_NON_GENERIC(0x0203 /*257*/), 315, 0xFFFFFFFF},
};
void Init16(void)
{
	IDSC(desc_16, 0, 15);
	IDSC(desc_16 + 1, 4, 15);
	IDSC(desc_16 + 32, 153, 15);
}
