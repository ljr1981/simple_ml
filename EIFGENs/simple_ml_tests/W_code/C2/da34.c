...
extern EIF_TYPED_VALUE F34_710(EIF_REFERENCE);
extern EIF_TYPED_VALUE F34_711(EIF_REFERENCE);
extern EIF_TYPED_VALUE F34_712(EIF_REFERENCE);
extern EIF_TYPED_VALUE F34_713(EIF_REFERENCE);
extern EIF_TYPED_VALUE F34_714(EIF_REFERENCE);
extern EIF_TYPED_VALUE F34_715(EIF_REFERENCE);
extern EIF_TYPED_VALUE F34_716(EIF_REFERENCE);
extern EIF_TYPED_VALUE F34_717(EIF_REFERENCE);
...
EIF_TYPED_VALUE F34_710 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F34_710,798,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F34_711)
EIF_TYPED_VALUE F34_711 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 33, Current, 0, 0, 798);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {349,0xFF01,267,0xFFFF};
		EIF_TYPE typres0;
...
RTOID (F34_712)
EIF_TYPED_VALUE F34_712 (EIF_REFERENCE Current)
{
	GTCX
...
RTOID (F34_713)
EIF_TYPED_VALUE F34_713 (EIF_REFERENCE Current)
{
	GTCX
...
RTOID (F34_714)
EIF_TYPED_VALUE F34_714 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 33, Current, 0, 0, 793);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F34_715 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F34_715,795,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F34_716 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F34_716,796,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F34_717 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F34_717,797,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
