...
extern EIF_TYPED_VALUE F50_931(EIF_REFERENCE);extern EIF_INTEGER_32 en_addrinfo_af_inet();

extern EIF_TYPED_VALUE F50_932(EIF_REFERENCE);extern EIF_INTEGER_32 en_addrinfo_af_inet6();
...
EIF_TYPED_VALUE F50_931 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 49, Current, 0, 0, 978);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
