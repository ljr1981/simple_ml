...
static const EIF_TYPE_INDEX egt_0_5 [] = {0xFF01,267,0xFFFF};
...
static const EIF_TYPE_INDEX egt_8_5 [] = {0xFF01,26,0xFFFF};
static const EIF_TYPE_INDEX egt_9_5 [] = {0xFF01,267,0xFFFF};
static const EIF_TYPE_INDEX egt_10_5 [] = {0xFF01,267,0xFFFF};
...
static const struct desc_info desc_5[] = {
	...
	{EIF_NON_GENERIC(0x01D9 /*236*/), 63, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01D9 /*236*/), 64, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01D9 /*236*/), 65, 0xFFFFFFFF},
};
void Init5(void)
{
	IDSC(desc_5, 0, 4);
	IDSC(desc_5 + 1, 4, 4);
	IDSC(desc_5 + 32, 274, 4);
}
