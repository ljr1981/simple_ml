...
extern EIF_TYPED_VALUE F88_1348(EIF_REFERENCE);
extern EIF_TYPED_VALUE F88_1349(EIF_REFERENCE);
extern EIF_TYPED_VALUE F88_1350(EIF_REFERENCE);
extern void F88_1351(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F88_1348 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 87, Current, 1, 0, 1371);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(87, Current, 1371);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F88_1349)
EIF_TYPED_VALUE F88_1349 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 87, Current, 0, 0, 1372);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(87, Current, 1372);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F88_1350)
EIF_TYPED_VALUE F88_1350 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 87, Current, 0, 0, 1373);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(87, Current, 1373);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000088, 0,0); /* Result */
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {722,254,0xFFFF};
		EIF_TYPE typres0;
...
void F88_1351 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 87, Current, 0, 1, 1374);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(87, Current, 1374);
