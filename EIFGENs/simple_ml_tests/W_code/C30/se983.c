...
extern EIF_TYPED_VALUE F983_3323(EIF_REFERENCE);
...
EIF_TYPED_VALUE F983_3323 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 4587);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 4587);
	RTIV(Current, RTAL);
	RTHOOK(1);
