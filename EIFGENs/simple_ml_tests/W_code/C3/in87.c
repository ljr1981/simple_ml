...
extern EIF_TYPED_VALUE F87_1345(EIF_REFERENCE);
extern EIF_TYPED_VALUE F87_1346(EIF_REFERENCE);
extern void F87_1347(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 86, Current, 1, 0, 1367);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(86, Current, 1367);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1262, dtype))(Current, up1x);
	RTHOOK(3);
...
RTOID (F87_1345)
EIF_TYPED_VALUE F87_1345 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 86, Current, 0, 0, 1368);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(86, Current, 1368);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
EIF_TYPED_VALUE F87_1346 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 86, Current, 0, 0, 1369);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(86, Current, 1369);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF8000088, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(137, 0x01).id);
...
void F87_1347 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 86, Current, 0, 1, 1370);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(86, Current, 1370);
